    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError(
        <>
          ...
          <br />
          But don't worry! You can always interact with the smart-contract through <a href={'https://etherscan.io/address/0x9204d50Bd5f9534d1E058F2b45999F09032063e4#writeContract'} target="_blank">{this.state.networkConfig.blockExplorer.name}</a> and <strong>we do our best to provide you with the best user experience possible</strong>, even from there.<br />
          <br />
              ...
              <>
                ...
                {!this.isSoldOut() ?
                  ...
                  <div className="collection-sold-out">
                    ...
                    You can buy from the beloved holders on <a href={'https://opensea.io/collection/rabbit-takeover-by-anne-spalter'} target="_blank">{CollectionConfig.marketplaceConfig.name}</a>.
                  </div>
                }
              </>
              :
        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              ...
              You can interact with the smart-contract <strong>directly</strong> through <a href={'https://etherscan.io/address/0x9204d50Bd5f9534d1E058F2b45999F09032063e4#writeContract'} target="_blank">{this.state.networkConfig.blockExplorer.name}</a>, without even connecting your wallet to this DAPP! <br />
              <br />
              Keep safe! 
            </div>
